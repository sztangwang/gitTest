...
class TestShoppingTrolley(object):
    ...
    def test_edit_shopping_trolley(self,login):
        print('###################################################',login)
...
if __name__=="__main__":
    pytest.main(['-vs', 'pytest03.py', '--alluredir', './report/xml'])
    os.system('pytest pytest03.py --alluredir=./tmp/my_allure_results --clean-alluredir')
